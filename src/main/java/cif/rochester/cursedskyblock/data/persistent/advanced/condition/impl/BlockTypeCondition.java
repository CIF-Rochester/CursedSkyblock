...
import cif.rochester.cursedskyblock.data.persistent.advanced.condition.types.BlockStateCondition;
...
public class BlockTypeCondition implements BlockStateCondition {
    @Save
    ...
    @Override
    public boolean isValid(BlockState block) {
